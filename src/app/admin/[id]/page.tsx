      ...
      <div className="lg:container mx-auto p-4">
       ...
       <div className="p-10">
         ...
         <div className="mb-4">
           ...
           <p className=" shadow appearance-none border border-jordy-blue-50  rounded w-full pb-20 px-3 text-jordy-blue-800  focus:outline-none focus:ring-1 transition ease-in-out duration-150">{find?.message}</p>
         </div>
